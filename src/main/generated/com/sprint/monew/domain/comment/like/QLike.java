...
public class QLike extends EntityPathBase<Like> {
    ...
    public final com.sprint.monew.domain.comment.QComment comment;
    ...
    public QLike(Class<? extends Like> type, PathMetadata metadata, PathInits inits) {
        ...
        this.comment = inits.isInitialized("comment") ? new com.sprint.monew.domain.comment.QComment(forProperty("comment"), inits.get("comment")) : null;
